...
- **Fuso Horário Adaptativo**: O sistema computa gastos e relatórios sincronizados automaticamente no fuso do Brasil (UTC-3), não importando o fuso do servidor de hospedagem.
